...
const Login = () => {
  ...
  return (
    <div className="h-screen w-full flex justify-center items-center bg-gradient-to-r from-violet-500 to-fuchsia-500">
      <div className="h-auto w-[500px] p-6 border rounded-lg shadow-lg bg-white">
        ...
        <form onSubmit={handleForm} className="space-y-4">
          <input
            ...
            className="w-full outline-none bg-slate-100 py-2 px-4 rounded-lg border-2 focus:border-x-violet-500"
          />
          <input
            ref={lname}
            required
            ...
            className="w-full outline-none bg-slate-100 py-2 px-4 rounded-lg border-2 focus:border-violet-500"
          />
          <input
            ref={age}
            required
          ...
          <button
            type="submit"
            className="w-full py-3 px-4 rounded-lg text-white bg-violet-600 hover:bg-violet-900 transition"
          >
